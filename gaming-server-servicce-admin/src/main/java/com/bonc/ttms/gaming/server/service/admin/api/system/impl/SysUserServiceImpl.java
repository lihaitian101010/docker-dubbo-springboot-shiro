...
import com.bonc.ttms.gaming.server.service.admin.api.system.dao.SysRoleDao;
import com.bonc.ttms.gaming.server.service.admin.api.system.dao.SysUserDao;
import com.bonc.ttms.gaming.server.service.admin.api.system.dao.SysUserRoleDao;
...
public class SysUserServiceImpl implements SysUserService {
	...
	public Map<String, Object> findPageObjects(String username, 
		...
		List<SysUser> list = userDao.findPageObjects(username,startIndex,pageSize);
	...
	public SysUser findObjectByName(String username) {
		return userDao.findObjectByName(username);
	}
