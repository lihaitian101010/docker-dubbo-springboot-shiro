...
//        credentialsMatcher.setHashIterations(2);
    ...
    public ShiroUserRealm shiroRealm() {
...
//        securityManager.setCacheManager(ehCacheManager());
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        logoutFilter.setRedirectUrl("/loginUI");
        ...
        filterChainDefinitionManager.put("/loginUI", "anon");
        filterChainDefinitionManager.put("/bootstrap/**", "anon");
        filterChainDefinitionManager.put("/static/**", "anon");
        filterChainDefinitionManager.put("/ttms/**", "anon");
        filterChainDefinitionManager.put("/**", "authc");
        shiroFilterFactoryBean.setFilterChainDefinitionMap(filterChainDefinitionManager);

        shiroFilterFactoryBean.setLoginUrl("/loginUI");
        shiroFilterFactoryBean.setSuccessUrl("/indexUI");
