...
public class ProjectController {
    ...
    public JsonResult doFindObjects(String name, Integer valid, int pageCurrent) {
    ...
    @ResponseBody
    @RequiresPermissions("product:project:valid,product:project:invalid")
    ...
    public JsonResult doUpdateObject(Project entity, HttpServletRequest request) {
