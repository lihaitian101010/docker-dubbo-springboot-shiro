$(document).ready(function(){
	...
	//新增
	$('#formHead').on('click','.btn_add',showAddUI)
	//修改
	$('#formHead').on('click','.btn_update',showEditUI)
	//删除
	$('#formHead').on('click','.btn_delete',deleteObject)
	doGetObjects()
})
//删除角色
...
function showEditUI(){
	...
	$('#container').data('roleId',checkecIds);
	$('#container').load('role/editUI');
}
//显示新增页面
function showAddUI(){
	var url = 'role/editUI';
