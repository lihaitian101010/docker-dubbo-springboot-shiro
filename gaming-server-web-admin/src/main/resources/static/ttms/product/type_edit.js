...
function doBack(){
    ...
    doClearData();
	//加载列表页面,重新显示查询结果
	var listUrl="type/listUI?t="+Math.random(1000);
	$("#container").load(listUrl);
}
/**根据id执行查询获得记录信息*/
function doFindObjectById(id){
	var url="type/doFindObjectById";
	var params={"id":id};
...
function doSaveOrUpdate(){
	...
	//2.发送异步请求提交数据
	var saveUrl="type/doSaveObject";
	var updateUrl="type/doUpdateObject";
...
//2.发送异步请求加载分类信息,更新Ztree节点内容
 var url="type/doFindZtreeObjects"
